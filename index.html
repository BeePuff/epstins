...
<head>
<meta charset="UTF-8">
<title>Neon Horror – Office Interior</title>
<style>
...
button { padding:14px 30px; font-size:18px; }
#hint {
  position:fixed;
  bottom:20px;
  width:100%;
...
<div id="hint">WASD move • Mouse look • F flashlight</div>
...
function init() {
  ...
  // Lighting — brighter indoor
  scene.add(new THREE.HemisphereLight(0xffffff, 0x444444, 0.8));
  scene.add(new THREE.AmbientLight(0x333333));

  flashlight = new THREE.SpotLight(0xffffff, 3, 35, Math.PI / 5, 0.4);
  ...
  // Ceiling
  wall(0, 4, 0, 80, 0.2, 80);

  // Office walls
  wall(0, 2, -40, 80, 4, 0.5);
  wall(0, 2, 40, 80, 4, 0.5);
  wall(-40, 2, 0, 0.5, 4, 80);
  wall(40, 2, 0, 0.5, 4, 80);

  // Interior hallway walls
  wall(-10, 2, 0, 0.5, 4, 50);
  wall(10, 2, 0, 0.5, 4, 50);
